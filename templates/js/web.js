    ...
    for (let i = 0; i < Players.length; i++) {
        if (Players[i].id != player.id && Players[i].x === player.x && Players[i].y === player.y){
            if (Players[i].color === "blue"){
                ...
                Players[i].Update( positioncercle[departbleu].x,Players[i].y = positioncercle[departbleu].y,-1,false)
                console.log(Players[i].x,Players[i].y,player.x,player.y)
                ...
                Players[i].step = 0;
                Players[i].atend = false;
                Players[i].Update( positioncercle[departvert].x,Players[i].y = positioncercle[departvert].y,-1,false)
                console.log(Players[i].x,Players[i].y,player.x,player.y)
                ...
                Players[i].step = 0;
                Players[i].atend = false;
                Players[i].Update( positioncercle[departrouge].x,Players[i].y = positioncercle[departrouge].y,-1,false)
                console.log(Players[i].x,Players[i].y,player.x,player.y)
            }
        }
    }
